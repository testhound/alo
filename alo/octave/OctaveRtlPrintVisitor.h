#ifndef _OCTAVE_RTL_PRINT_VISITOR_H_
#define _OCTAVE_RTL_PRINT_VISITOR_H_
...
namespace Llir
{
  ...
  class OctaveRtlPrintVisitor : public Visitor, public LlirOctaveVisitor
    {
    public:
      OctaveRtlPrintVisitor(ostream& outputStream);
      ~OctaveRtlPrintVisitor();
