#ifndef _OCTAVE_UPDATE_OPND_VISITOR_H_
#define _OCTAVE_UPDATE_OPND_VISITOR_H_
...
namespace Alo
{
  ...
  class OctaveUpdateOpndVisitor :
    public Visitor,
    public LlirOctaveVisitor
    {
    public:
      
      OctaveUpdateOpndVisitor(OctaveAlo &o);
				            
      OctaveUpdateOpndVisitor(const OctaveUpdateOpndVisitor& rhs);
      
      const OctaveUpdateOpndVisitor& operator=(const OctaveUpdateOpndVisitor& rhs);
       
      virtual ~OctaveUpdateOpndVisitor()  {}
    ...
    private:
      ...
      //visitor internal bookkeeping lists
