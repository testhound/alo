#ifndef _M480_BRANCH_INSN_VISITOR_H
#define _M480_BRANCH_INSN_VISITOR_H
...
namespace Alo
{
  ...
  class M480BranchInsnVisitor : 
    public OctaveBranchInsnVisitor,
    public M480Visitor
    {
    public:

      M480BranchInsnVisitor(OctaveAlo &i,   	
			    shared_ptr<AltEntryFunction> fn);

      M480BranchInsnVisitor(const M480BranchInsnVisitor& rhs);
      const M480BranchInsnVisitor& operator=(const M480BranchInsnVisitor&);

      ~M480BranchInsnVisitor(){}
  ...
  class M480CallInsnVisitor : 
    public OctaveBranchInsnVisitor,
    public M480Visitor
    {
    public:

      M480CallInsnVisitor(OctaveAlo &i,   	
			  shared_ptr<AltEntryFunction> fn);

      M480CallInsnVisitor(const M480CallInsnVisitor& rhs);
      const M480CallInsnVisitor& operator=(const M480CallInsnVisitor&);
