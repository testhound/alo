#ifndef _M480_RTL_PRINT_VISITOR_H
#define _M480_RTL_PRINT_VISITOR_H
...
namespace Llir
{
  ...
  class M480RtlPrintVisitor : public OctaveRtlPrintVisitor, 
                              public M480Visitor
    {
    public:
      M480RtlPrintVisitor(ostream& outputStream);
      ~M480RtlPrintVisitor();
