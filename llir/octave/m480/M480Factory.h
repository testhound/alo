#ifndef _LLIR_M480_FACTORY_H
#define _LLIR_M480_FACTORY_H
...
namespace Llir
{
  class M480Factory : public OctaveFactory
    {
    public:
      M480Factory();
      ~M480Factory();
      ...
      shared_ptr<OctaveInstruction> createJaddwhInstruction(unsigned int lineNum,
							    unsigned int srcLineNum,
							    const char* srcFileName,
							    shared_ptr<const Register>, 
							    shared_ptr<const Register>, 
      ...
      shared_ptr<OctaveInstruction> createJaddwlInstruction(unsigned int lineNum,
							    unsigned int srcLineNum,
							    const char* srcFileName,
							    shared_ptr<const Register>, 
							    shared_ptr<const Register>, 
      ...
      shared_ptr<OctaveInstruction> createJaddwwInstruction(unsigned int lineNum,
							    unsigned int srcLineNum,
							    const char* srcFileName,
							    shared_ptr<const Register>, 
							    shared_ptr<const Register>, 
      ...
      shared_ptr<OctaveInstruction> createJaddlInstruction(unsigned int lineNum,
							   unsigned int srcLineNum,
							   const char* srcFileName,
							   shared_ptr<const Register>, 
							   shared_ptr<const Register>, 
      ...
      shared_ptr<OctaveInstruction> createJaddwhiInstruction(unsigned int lineNum,
							     unsigned int srcLineNum,
							     const char* srcFileName,
							     shared_ptr<const UnsignedImmediate>, 
							     shared_ptr<const Register>, 
      ...
      shared_ptr<OctaveInstruction> createJaddwliInstruction(unsigned int lineNum,
							     unsigned int srcLineNum,
							     const char* srcFileName,
							     shared_ptr<const UnsignedImmediate>, 
							     shared_ptr<const Register>, 
      ...
      shared_ptr<OctaveInstruction> createJaddwwiInstruction(unsigned int lineNum,
							     unsigned int srcLineNum,
							     const char* srcFileName,
							     shared_ptr<const UnsignedImmediate>, 
							     shared_ptr<const Register>, 
      ...
      shared_ptr<OctaveInstruction> createJaddliInstruction(unsigned int lineNum,
							    unsigned int srcLineNum,
							    const char* srcFileName,
							    shared_ptr<const UnsignedImmediate>, 
							    shared_ptr<const Register>, 
      ...
      shared_ptr<OctaveInstruction> createJsubwhInstruction(unsigned int lineNum,
							    unsigned int srcLineNum,
							    const char* srcFileName,
							    shared_ptr<const Register>, 
							    shared_ptr<const Register>, 
      ...
      shared_ptr<OctaveInstruction> createJsubwlInstruction(unsigned int lineNum,
							    unsigned int srcLineNum,
							    const char* srcFileName,
							    shared_ptr<const Register>, 
							    shared_ptr<const Register>, 
      ...
      shared_ptr<OctaveInstruction> createJsubwwInstruction(unsigned int lineNum,
							    unsigned int srcLineNum,
							    const char* srcFileName,
							    shared_ptr<const Register>, 
							    shared_ptr<const Register>, 
      ...
      shared_ptr<OctaveInstruction> createJsublInstruction(unsigned int lineNum,
							   unsigned int srcLineNum,
							   const char* srcFileName,
							   shared_ptr<const Register>, 
							   shared_ptr<const Register>, 
      ...
      shared_ptr<OctaveInstruction> createJsubwhiInstruction(unsigned int lineNum,
							     unsigned int srcLineNum,
							     const char* srcFileName,
							     shared_ptr<const UnsignedImmediate>, 
							     shared_ptr<const Register>, 
      ...
      shared_ptr<OctaveInstruction> createJsubwliInstruction(unsigned int lineNum,
							     unsigned int srcLineNum,
							     const char* srcFileName,
							     shared_ptr<const UnsignedImmediate>, 
							     shared_ptr<const Register>, 
      ...
      shared_ptr<OctaveInstruction> createJsubwwiInstruction(unsigned int lineNum,
							     unsigned int srcLineNum,
							     const char* srcFileName,
							     shared_ptr<const UnsignedImmediate>, 
							     shared_ptr<const Register>, 
      ...
      shared_ptr<OctaveInstruction> createJsubliInstruction(unsigned int lineNum,
							    unsigned int srcLineNum,
							    const char* srcFileName,
							    shared_ptr<const UnsignedImmediate>, 
							    shared_ptr<const Register>, 
      ...
      shared_ptr<OctaveInstruction> createJbcdrInstruction(unsigned int lineNum,
							   unsigned int srcLineNum,
							   const char* srcFileName,
							   shared_ptr<const Register> src1, 
							   shared_ptr<EssFlag>, 
      ...
      shared_ptr<OctaveInstruction> createJbcdiInstruction(unsigned int lineNum,
							   unsigned int srcLineNum,
							   const char* srcFileName,
							   shared_ptr<const LlirOperand> src1, 
							   shared_ptr<EssFlag>, 
      ...
      shared_ptr<OctaveInstruction> createJbcrInstruction(unsigned int lineNum,
							  unsigned int srcLineNum,
							  const char* srcFileName,
							  shared_ptr<const Register> src1, 
							  shared_ptr<EssFlag>, 
      ...
      shared_ptr<OctaveInstruction> createJbciInstruction(unsigned int lineNum,
							  unsigned int srcLineNum,
							  const char* srcFileName,
							  shared_ptr<const LlirOperand> src1, 
							  shared_ptr<EssFlag>, 
      ...
      shared_ptr<OctaveInstruction> createJbnzrInstruction(unsigned int lineNum,
							   unsigned int srcLineNum,
							   const char* srcFileName,
							   shared_ptr<const Register> src1, 
							   shared_ptr<const Register> src2, 
      ...
      shared_ptr<OctaveInstruction> createJbzrInstruction(unsigned int lineNum,
							  unsigned int srcLineNum,
							  const char* srcFileName,
							  shared_ptr<const Register> src1, 
							  shared_ptr<const Register> src2, 
      ...
      shared_ptr<OctaveInstruction> createJbnziInstruction(unsigned int lineNum,
							   unsigned int srcLineNum,
							   const char* srcFileName,
							   shared_ptr<const Register> src1, 
							   shared_ptr<const LlirOperand> src2, 
      ...
      shared_ptr<OctaveInstruction> createJbziInstruction(unsigned int lineNum,
							  unsigned int srcLineNum,
							  const char* srcFileName,
							  shared_ptr<const Register> src1, 
							  shared_ptr<const LlirOperand> src2, 
      ...
      shared_ptr<OctaveInstruction> createJtsetbInstruction(unsigned int lineNum,
							    unsigned int srcLineNum,
							    const char* srcFileName,
							    shared_ptr<const Register> src1, 
							    shared_ptr<const UnsignedImmediate> bitpos, 
      ...
      shared_ptr<OctaveInstruction> createJtclrbInstruction(unsigned int lineNum,
							    unsigned int srcLineNum,
							    const char* srcFileName,
							    shared_ptr<const Register> src1, 
							    shared_ptr<const UnsignedImmediate> bitpos, 
      ...
      shared_ptr<OctaveInstruction> createJrnmiInstruction(unsigned int lineNum,
							   unsigned int srcLineNum,
							   const char* srcFileName,
							   shared_ptr<const LlirOperand> diFlag);
      
      shared_ptr<OctaveInstruction> createJrintInstruction(unsigned int lineNum,
							   unsigned int srcLineNum,
							   const char* srcFileName,
							   shared_ptr<const LlirOperand> diFlag);
      
      shared_ptr<OctaveInstruction> createJbrsInstruction(unsigned int lineNum,
							  unsigned int srcLineNum,
							  const char* srcFileName,
							  shared_ptr<const LlirOperand> dst);
      
      shared_ptr<OctaveInstruction> createJbrslInstruction(unsigned int lineNum,
							   unsigned int srcLineNum,
							   const char* srcFileName,
							   shared_ptr<const LlirOperand> brslFlags);

      shared_ptr<OctaveInstruction> createJbiInstruction(unsigned int lineNum,
							 unsigned int srcLineNum,
							 const char* srcFileName,
							 shared_ptr<const LlirOperand> src1,
							 shared_ptr<const LlirOperand> dst, 
      ...
      shared_ptr<OctaveInstruction> createJbrInstruction(unsigned int lineNum,
							 unsigned int srcLineNum,
							 const char* srcFileName,
							 shared_ptr<const Register> src1,
							 shared_ptr<const LlirOperand> dst,
